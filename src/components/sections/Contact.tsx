    ...
    >
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="font-jp-gothic text-gray-700 dark:text-gray-300 max-w-2xl mx-auto mb-12">
            {t("description")}
          </p>
          ...
          <div className="flex flex-col items-center space-y-8">
            ...
            >
              ...
              <span className="text-lg">{t("socialLinks.linkedin")}</span>
            </motion.a>
            ...
            <div className="flex justify-center space-x-8">
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-ai-600 hover:text-ai-700 transition-colors"
                whileHover={{ scale: 1.05 }}
              >
                <svg className="w-8 h-8 fill-current" viewBox="0 0 24 24">
